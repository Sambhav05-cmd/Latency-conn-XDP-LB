...
const file_proto_control_proto_rawDesc = "" +
	...
	"\rDeleteBackend\x12\x1d.control.DeleteBackendRequest\x1a\x0e.control.EmptyB\n" +
...
var file_proto_control_proto_depIdxs = []int32{
	...
	3, // 3: control.WeightControl.UpdateWeight:output_type -> control.Empty
	3, // 4: control.WeightControl.AddBackend:output_type -> control.Empty
	3, // 5: control.WeightControl.DeleteBackend:output_type -> control.Empty
